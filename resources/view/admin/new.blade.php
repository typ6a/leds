            ...
            <form method="POST" action="/admin/product/save" class="form-horizontal" enctype="multipart/form-data" role="form">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input id="name" name="product[title]" type="text" placeholder="Product name" class="form-control input-md" required="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" id="textarea" name="user[email]"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
